...
#
# Convert xyz data into poscar format for theoretically max. packed state
# In fact, this kind of structure doesn't exist
# 07/30/2004 Byoungseon Jeon @LANL
#
print "================================================"
...
print >> poscar,  '     %19.16f %19.16f %19.16f' % (1./sqrt2/4.0, -sqrt6/8., 0.0)
print >> poscar,  '     %19.16f %19.16f %19.16f' % (1./sqrt2/4.0, sqrt6/8., 0.0)
